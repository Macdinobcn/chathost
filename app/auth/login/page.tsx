...
// Login con magic link + Google OAuth
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: 32 }}>
          <img src="/logo.png" alt="ChatHost.ai" style={{ height: 36, width: 'auto', marginBottom: 16 }} />
          <p style={{ fontSize: 14, color: '#64748b', margin: 0 }}>Accede a tu panel</p>
        </div>
        ...
        {!sent ? (
          ...
          <div style={{ textAlign: 'center' }}>
            ...
            <p style={{ fontSize: 13, color: '#475569' }}>El link expira en 60 minutos.</p>
