...
// Genera un widget_id único y legible
...
// GET /api/clients — lista todos los clientes (solo admin)
...
// POST /api/clients — crear nuevo cliente (solo admin)
export async function POST(req: NextRequest) {
  try {
    const { name, website_url, email, plan, widget_color, widget_name } =
      await req.json()
