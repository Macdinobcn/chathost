              ...
              {themePanelOpen && (
                <div style={{ position: 'absolute', top: 42, right: 0, zIndex: 500, background: 'white', border: '1px solid #e5e7eb', borderRadius: 12, padding: 16, width: 220, boxShadow: '0 8px 32px rgba(0,0,0,0.12)' }}>
                  ...
                  <div style={{ display: 'flex', gap: 7, alignItems: 'center' }}>
                    ...
                    <input type="text" value={themeCustomInput} onChange={e => setThemeCustomInput(e.target.value)} onBlur={e => { if (/^#[0-9a-fA-F]{6}$/.test(e.target.value)) aplicarTema(e.target.value) }} placeholder="#2563eb" style={{ ...S.inp, flex: 1, width: 'auto', fontSize: 12, padding: '6px 9px' }} />
                  </div>
                </div>
              )}
            </div>
