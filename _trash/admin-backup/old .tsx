...
const s = {
  ...
  topbar: { background: 'white', borderBottom: '1px solid #eaecf0', padding: '0 28px', height: 56, display: 'flex', alignItems: 'center', justifyContent: 'space-between' } as React.CSSProperties,
      ...
      <div style={s.topbar}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 20 }}>
          <Link href="/admin" style={{ textDecoration: 'none', display: 'flex', alignItems: 'center', gap: 8 }}>
            ...
            <span style={{ fontSize: 11, color: '#98a2b3', fontWeight: 600 }}>ADMIN</span>
          </Link>
          <nav style={{ display: 'flex', gap: 4 }}>
            <Link href="/admin" style={{ fontSize: 12, fontWeight: 600, color: '#101828', padding: '5px 10px', borderRadius: 6, background: '#f5f5f5', textDecoration: 'none' }}>
              Clientes
            </Link>
            <Link href="/admin/settings" style={{ fontSize: 12, fontWeight: 500, color: '#555', padding: '5px 10px', borderRadius: 6, textDecoration: 'none' }}>
              ⚙️ Configuración
            </Link>
          </nav>
        </div>
        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
          {actualizado && <span style={{ fontSize: 11, color: '#98a2b3' }}>Actualizado: {actualizado}</span>}
          <button onClick={cargar} style={{ fontSize: 11, padding: '5px 12px', borderRadius: 6, border: '1px solid #eaecf0', background: 'white', color: '#555', cursor: 'pointer' }}>↺ Refresh</button>
          <Link href="/admin/clients/new" style={{ background: '#4f46e5', color: 'white', padding: '7px 16px', borderRadius: 8, textDecoration: 'none', fontSize: 12, fontWeight: 600 }}>
            + Nuevo cliente
          </Link>
        </div>
      </div>
